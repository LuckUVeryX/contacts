...
import '../../features/edit_contact/presentation/pages/edit_contact_page.dart'
    as _i3;
import '../domain/entities/contact.dart' as _i6;
...
class ContactInfoRoute extends _i4.PageRouteInfo<ContactInfoRouteArgs> {
  ContactInfoRoute({_i5.Key? key, required _i6.Contact contact})
      : super(ContactInfoRoute.name,
            path: '/contact-info-page',
            args: ContactInfoRouteArgs(key: key, contact: contact));

  static const String name = 'ContactInfoRoute';
}

class ContactInfoRouteArgs {
  const ContactInfoRouteArgs({this.key, required this.contact});
  ...
  @override
  String toString() {
    return 'ContactInfoRouteArgs{key: $key, contact: $contact}';
  }
}
